...
bool mecanumbot_msgs__msg__sensor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mecanumbot_msgs.msg._sensor_state.SensorState", full_classname_dest, 45) == 0);
  }
  mecanumbot_msgs__msg__SensorState * ros_message = _ros_message;
  {  // header
  ...
  {  // frontleft_encoder
    PyObject * field = PyObject_GetAttrString(_pymsg, "frontleft_encoder");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->frontleft_encoder = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // frontright_encoder
    PyObject * field = PyObject_GetAttrString(_pymsg, "frontright_encoder");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->frontright_encoder = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // backright_encoder
    PyObject * field = PyObject_GetAttrString(_pymsg, "backright_encoder");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->backright_encoder = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // backleft_encoder
    PyObject * field = PyObject_GetAttrString(_pymsg, "backleft_encoder");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->backleft_encoder = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // battery
...
PyObject * mecanumbot_msgs__msg__sensor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mecanumbot_msgs.msg._sensor_state");
  ...
  {  // frontleft_encoder
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->frontleft_encoder);
    {
      int rc = PyObject_SetAttrString(_pymessage, "frontleft_encoder", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // frontright_encoder
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->frontright_encoder);
    {
      int rc = PyObject_SetAttrString(_pymessage, "frontright_encoder", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // backright_encoder
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->backright_encoder);
    {
      int rc = PyObject_SetAttrString(_pymessage, "backright_encoder", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // backleft_encoder
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->backleft_encoder);
    {
      int rc = PyObject_SetAttrString(_pymessage, "backleft_encoder", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
