...
static const _GetLedStatus_Request_type_support_symbol_names_t _GetLedStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecanumbot_msgs, srv, GetLedStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mecanumbot_msgs, srv, GetLedStatus_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mecanumbot_msgs, srv, GetLedStatus_Request)() {
  return &::mecanumbot_msgs::srv::rosidl_typesupport_c::GetLedStatus_Request_message_type_support_handle;
}
...
static const _GetLedStatus_Response_type_support_symbol_names_t _GetLedStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecanumbot_msgs, srv, GetLedStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mecanumbot_msgs, srv, GetLedStatus_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mecanumbot_msgs, srv, GetLedStatus_Response)() {
  return &::mecanumbot_msgs::srv::rosidl_typesupport_c::GetLedStatus_Response_message_type_support_handle;
}
...
static const _GetLedStatus_type_support_symbol_names_t _GetLedStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecanumbot_msgs, srv, GetLedStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mecanumbot_msgs, srv, GetLedStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mecanumbot_msgs, srv, GetLedStatus)() {
  return &::mecanumbot_msgs::srv::rosidl_typesupport_c::GetLedStatus_service_type_support_handle;
}
