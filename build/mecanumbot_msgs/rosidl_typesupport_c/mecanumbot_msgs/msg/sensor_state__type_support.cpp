...
static const _SensorState_type_support_symbol_names_t _SensorState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecanumbot_msgs, msg, SensorState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mecanumbot_msgs, msg, SensorState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mecanumbot_msgs, msg, SensorState)() {
  return &::mecanumbot_msgs::msg::rosidl_typesupport_c::SensorState_message_type_support_handle;
}
