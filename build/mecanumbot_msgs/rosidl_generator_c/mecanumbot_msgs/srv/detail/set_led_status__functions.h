...
#ifndef MECANUMBOT_MSGS__SRV__DETAIL__SET_LED_STATUS__FUNCTIONS_H_
#define MECANUMBOT_MSGS__SRV__DETAIL__SET_LED_STATUS__FUNCTIONS_H_
 ...
 * calls
 * mecanumbot_msgs__srv__SetLedStatus_Request__init().
...
/**
 * It calls
 * mecanumbot_msgs__srv__SetLedStatus_Request__fini()
 ...
 * mecanumbot_msgs__srv__SetLedStatus_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mecanumbot_msgs__srv__SetLedStatus_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mecanumbot_msgs__srv__SetLedStatus_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecanumbot_msgs
...
/**
 * It calls
 * mecanumbot_msgs__srv__SetLedStatus_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mecanumbot_msgs
...
/**
 * It allocates the memory for the array and calls
 * mecanumbot_msgs__srv__SetLedStatus_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecanumbot_msgs
...
/**
 * It calls
 * mecanumbot_msgs__srv__SetLedStatus_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MECANUMBOT_MSGS__SRV__DETAIL__SET_LED_STATUS__FUNCTIONS_H_
