...
#include "mecanumbot_msgs/srv/detail/set_led_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mecanumbot_msgs::srv::SetLedStatus_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mecanumbot_msgs::srv::SetLedStatus_Request & ros_message)
{
  // Member: fl_mode
  cdr >> ros_message.fl_mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mecanumbot_msgs::srv::SetLedStatus_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mecanumbot_msgs::srv::SetLedStatus_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mecanumbot_msgs::srv::SetLedStatus_Request *>(
    untyped_ros_message);
...
{
  return &mecanumbot_msgs::srv::typesupport_fastrtps_cpp::_SetLedStatus_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecanumbot_msgs, srv, SetLedStatus_Request)() {
  return &mecanumbot_msgs::srv::typesupport_fastrtps_cpp::_SetLedStatus_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mecanumbot_msgs
cdr_serialize(
  const mecanumbot_msgs::srv::SetLedStatus_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mecanumbot_msgs::srv::SetLedStatus_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mecanumbot_msgs::srv::SetLedStatus_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mecanumbot_msgs::srv::SetLedStatus_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mecanumbot_msgs::srv::SetLedStatus_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mecanumbot_msgs::srv::typesupport_fastrtps_cpp::_SetLedStatus_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecanumbot_msgs, srv, SetLedStatus_Response)() {
  return &mecanumbot_msgs::srv::typesupport_fastrtps_cpp::_SetLedStatus_Response__handle;
}
...
{
  return &mecanumbot_msgs::srv::typesupport_fastrtps_cpp::_SetLedStatus__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecanumbot_msgs, srv, SetLedStatus)() {
  return &mecanumbot_msgs::srv::typesupport_fastrtps_cpp::_SetLedStatus__handle;
}
