...
#include "mecanumbot_msgs/msg/detail/sensor_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mecanumbot_msgs::msg::SensorState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mecanumbot_msgs::msg::SensorState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mecanumbot_msgs::msg::SensorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mecanumbot_msgs::msg::SensorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mecanumbot_msgs::msg::SensorState *>(
    untyped_ros_message);
...
get_message_type_support_handle<mecanumbot_msgs::msg::SensorState>()
{
  return &mecanumbot_msgs::msg::typesupport_fastrtps_cpp::_SensorState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecanumbot_msgs, msg, SensorState)() {
  return &mecanumbot_msgs::msg::typesupport_fastrtps_cpp::_SensorState__handle;
}
