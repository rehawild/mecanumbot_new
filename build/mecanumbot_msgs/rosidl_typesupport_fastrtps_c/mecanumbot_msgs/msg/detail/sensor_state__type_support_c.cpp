...
#include "mecanumbot_msgs/msg/detail/sensor_state__rosidl_typesupport_fastrtps_c.h"
...
using _SensorState__ros_msg_type = mecanumbot_msgs__msg__SensorState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: frontleft_encoder
  {
    cdr << ros_message->frontleft_encoder;
  }

  // Field name: frontright_encoder
  {
    cdr << ros_message->frontright_encoder;
  }

  // Field name: backright_encoder
  {
    cdr << ros_message->backright_encoder;
  }

  // Field name: backleft_encoder
  {
    cdr << ros_message->backleft_encoder;
  }
...
size_t get_serialized_size_mecanumbot_msgs__msg__SensorState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SensorState__ros_msg_type * ros_message = static_cast<const _SensorState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name frontleft_encoder
  {
    size_t item_size = sizeof(ros_message->frontleft_encoder);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name frontright_encoder
  {
    size_t item_size = sizeof(ros_message->frontright_encoder);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name backright_encoder
  {
    size_t item_size = sizeof(ros_message->backright_encoder);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name backleft_encoder
  {
    size_t item_size = sizeof(ros_message->backleft_encoder);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name battery
...
static uint32_t _SensorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mecanumbot_msgs__msg__SensorState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mecanumbot_msgs
size_t max_serialized_size_mecanumbot_msgs__msg__SensorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mecanumbot_msgs__msg__SensorState;
    is_plain =
      (
...
static size_t _SensorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mecanumbot_msgs__msg__SensorState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecanumbot_msgs, msg, SensorState)() {
