...
static const _OpenCRState_type_support_symbol_names_t _OpenCRState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecanumbot_msgs, msg, OpenCRState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mecanumbot_msgs, msg, OpenCRState)),
  }
};
...
{
  return &::mecanumbot_msgs::msg::rosidl_typesupport_cpp::OpenCRState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mecanumbot_msgs, msg, OpenCRState)() {
  return get_message_type_support_handle<mecanumbot_msgs::msg::OpenCRState>();
}
