...
static const _SensorState_type_support_symbol_names_t _SensorState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecanumbot_msgs, msg, SensorState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mecanumbot_msgs, msg, SensorState)),
  }
};
...
{
  return &::mecanumbot_msgs::msg::rosidl_typesupport_cpp::SensorState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mecanumbot_msgs, msg, SensorState)() {
  return get_message_type_support_handle<mecanumbot_msgs::msg::SensorState>();
}
